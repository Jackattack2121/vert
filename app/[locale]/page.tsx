...
export default function HomePage() {
  ...
  return (
    <main>
      {/* Hero Section - Montfort-style with deep teal background */}
      <section className="relative min-h-screen flex items-end pb-32 bg-primary-500 overflow-hidden">
      ...
      <section className="section-padding bg-cream-100">
        <div className="container">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <AnimatedSection>
              <div className="bg-primary-500/5 rounded-lg aspect-[4/3] flex items-center justify-center">
                <div className="text-center p-8">
                  <div className="w-24 h-24 mx-auto mb-4 rounded-full bg-primary-500/10 flex items-center justify-center">
                  ...
                  <p className="font-sans text-sm text-secondary-400">3D Illustration</p>
                </div>
              </div>
            </AnimatedSection>
      ...
      {/* Full-bleed Image Section - Montfort style */}
      <section className="relative h-[50vh] lg:h-[60vh] overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-primary-500/20 to-primary-700/40">
          <div className="absolute inset-0 bg-cream-200 flex items-center justify-center">
            <p className="font-sans text-secondary-400 text-sm">Full-bleed Photography</p>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <AnimatedSection>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {[1, 2, 3, 4].map((num) => (
                <div key={num} className="bg-white rounded-md p-8 flex items-center justify-center h-32 shadow-[0_1px_3px_rgba(0,0,0,0.04)] hover:shadow-elegant transition-shadow duration-300">
                  <span className="font-serif text-lg text-secondary-400">Company {num}</span>
                </div>
              ))}
            </div>
          </AnimatedSection>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <AnimatedSection>
              <div className="group relative overflow-hidden rounded-md bg-cream-100 p-10 lg:p-14 hover:-translate-y-1 hover:shadow-card-hover transition-all duration-300">
                ...
                <Link href="/investors" className="inline-flex items-center gap-2 font-sans text-sm font-medium text-accent-gold tracking-wide group-hover:gap-4 transition-all duration-300">
