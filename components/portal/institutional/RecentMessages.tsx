  ...
  const fetchMessages = async () => {
    try {
      ...
      const mockData: Message[] = [
        { id: '1', subject: 'Project timeline discussion', status: 'replied', createdAt: '2024-02-08', read: true },
        { id: '2', subject: 'Meeting follow-up', status: 'open', createdAt: '2024-02-06', read: false },
      ];
    ...
    <div className="bg-white rounded-lg shadow">
      <div className="p-4 border-b">
        <div className="flex items-center justify-between">
          ...
          <Link
            href="/portal/institutional/messages"
      ...
      <div className="divide-y">
        {messages.length === 0 ? (
          ...
          messages.map((message) => (
            <Link
              key={message.id}
              href={`/portal/institutional/messages/${message.id}`}
      ...
      <div className="p-4 border-t">
        <Link
          href="/portal/institutional/messages/new"
